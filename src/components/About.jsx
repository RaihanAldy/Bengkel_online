    ...
    <section className="py-20 bg-gray-100">
      <div className="container mx-auto flex flex-col lg:flex-row items-center gap-10 px-6">
        ...
        <div className="relative w-full lg:w-1/2">
          ...
          whileInView={{ scale: 1, opacity: 1 }} // Geser ke posisi normal
        ...
        <div className="w-full lg:w-1/2">
          ...
          <button  onClick={handleNavigation} className="border border-gray-900 text-white px-6 py-2 rounded-full hover:bg-gray-900 hover:text-white transition">
           More About Us
          </button>
          </motion.div>
        </div>
